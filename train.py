...
def train_epochs(model:Module,epochs:int,train_dataloader:DataLoader,eval_dataloader:DataLoader,optimizer:optim,loss_fn):
    """
    ...
    for epoch in tqdm(range(epochs)):
        ...
        writer.add_scalar('Loss/eval', train_epoch_loss, epoch)
    return model
...
def test_train():
    ...
    trained_model = train_epochs(model,50,train_loader,eval_loader,optimizer,regression_loss_fn)
    pass
